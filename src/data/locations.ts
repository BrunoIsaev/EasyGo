...
export const ALL_LOCATIONS: Location[] = [
  ...
  { id: 'shalbuzdag', name: 'Гора Шалбуздаг', coords: [41.550000, 47.950000], type: 'nature', description: 'Священная гора' },
  { id: 'huchni-wp', name: 'Хучнинский водопад', coords: [41.972165, 47.928282], type: 'nature' },
  { id: 'saltin-wp', name: 'Салтинский водопад', coords: [42.420000, 47.050000], type: 'nature', description: 'Подземный водопад' },
  { id: 'itlyatlar-wp', name: 'Водопад Итлятляр', coords: [42.470000, 47.100000], type: 'nature' },
