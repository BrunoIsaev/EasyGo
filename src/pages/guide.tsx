...
const ADVENTURE_TOURS_DATA: Record<string, any> = {
  ...
  // Новые гастротуры из буклетов
  'gas-gerey': { 
    id: 'gas-gerey', 
    title: 'Семейная винодельня «Герей-Тюз»', 
    basePrice: 5500, 
    program: [
      'Трансфер на виноградники «Герей-Тюз»',
      'Экскурсия по винодельне и дегустация сортов (Молдова, Мускат, Саперави)',
      'Посещение Крепости семи братьев',
      'Национальный обед',
      'Мастер-класс по приготовлению чуду',
      'Прогулка к Ханagскому водопаду и мосту Зюртинг'
    ] 
  },
  'gas-summer': { 
    id: 'gas-summer', 
    ...
    program: [
      ...
      'Осмотр Гимринской башни и Ирганайского водохранилища',
      'Посещение абрикосовых садов Гуниба (дегустация сортов Шалах, Краснощёкий)',
